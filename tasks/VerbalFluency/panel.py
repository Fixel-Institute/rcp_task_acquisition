...
from tasks.VerbalFluency.constants import (PHONEMIC_LIST, SEMANTIC_LIST, VERBAL_FLUENCY_PATHS,
...
class VerbalFluencyPanel(TrialPanel):
    ...
    def _setup_panel(self):
        ...
        self.phonemic_list = PHONEMIC_LIST
    ...
    def switch_panel(self):
        ...
        self.phonemic_list = json.loads(self.phonemic_list[self.phonemic_choice.GetSelection()])
        self.semantic = self.semantic_list[self.semantic_choice.GetSelection()]
        

        phonemic_key = "".join(self.phonemic_list)
        self.instruction_paths = VERBAL_FLUENCY_PATHS[phonemic_key]
        self.instruction_paths[self.semantic] = VERBAL_FLUENCY_PATHS["Semantic"][self.semantic]
