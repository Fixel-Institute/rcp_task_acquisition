...
2. The code can be installed in any part of computer but for following this installation, it will be installed in **Documents**
    - `cd Documents`
    - `conda create -n ucsf-rcp-task-acquisition python=3.10`
    - `conda activate ucsf-rcp-task-acquisition` - Note: You must run this line each time before launching the program from the command line.
    - `git clone https://github.com/Fixel-Institute/rcp_task_acquisition.git`
