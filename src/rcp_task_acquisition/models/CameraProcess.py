...
from rcp_task_acquisition.models.AsyncVideoWriter import AsyncVideoWriter
                    ...
                    if msg == 'InitC':
                        ...
                        while self.aq.value > 0:
                            ...
                            if record:
                                ...
                                ok = self.async_writer.write(frame_bgr, frame_id, capture_duration)
                                if not ok:
                        ...
                        current_exposure_time = cam.ExposureTime.GetValue()*.99
                        cam.ExposureAuto.SetValue(PySpin.ExposureAuto_Off)
