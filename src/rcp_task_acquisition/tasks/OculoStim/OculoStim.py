...
def get_saccade_config(v = ["10.0", 40, 1000, 0, 0, 1000, "random"]) -> dict:
    return {
...
def get_fixation_config(v = ["20.0", "15.0", 20, 1000, 0, 1000, "random"]) -> dict:
    return {
...
def get_default_config(v = [57.0, 52.7, 1920, 1080, 0, "Saccade Block", "localhost", 9000, True, True, True, False, False, "oculostim", str(Path.home())]) -> dict:
    return {
